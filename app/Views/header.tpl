<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="{base_url()}/public/css/knacss.css">
...
<div class="autogrid">
    ...
    <a href="{base_url()}/public/inscription" class="bar"><div class="button-bar"><i class="fas fa-user-plus"></i> Inscription</div></a>
    <a href="{base_url()}/public/connexion" class="bar"><div class="button-bar"><i class="fas fa-lock"></i> Connexion</div></a>
</div>
